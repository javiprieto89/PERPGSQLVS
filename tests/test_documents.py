...
def test_create_get_update_delete_documents(db_session):
    # Crear
    data = CommercialDocumentsCreate(CompanyID=1, BranchID=1, DocumentTypeID=1, CurrencyID=1, DocumentDescription="Documento Test", DocumentNumber=1, PointOfSale=1, IsFiscal=False,
                                     IsElectronic=False, IsManual=False, IsQuotation=False, IsActive=True, IsTest=False, MaxItems=10, ShouldAccount=True, AffectsStock=False, FromDate="2025-01-01")
    ...
    # Actualizar
    update = CommercialDocumentsUpdate(
        DocumentDescription="Documento Modificado")
