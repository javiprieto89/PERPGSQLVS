...
from app.graphql.crud.systransactiontypes import (
    create_systransactiontypes,
    get_systransactiontypes,
    update_systransactiontypes,
    delete_systransactiontypes,
)
...
def test_create_get_update_delete_systransactiontypes(db_session):
    ...
    assert any(o.TransactTypeID ==
               obj.TransactTypeID for o in all_objs)
    # Actualizar
    ...
    assert all(o.TransactTypeID !=
               obj.TransactTypeID for o in get_systransactiontypes(db_session))
