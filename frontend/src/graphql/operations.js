import { afipOperations } from "~/graphql/afipOperations.js";
...
import { clientHelpers, orderHelpers, supplierHelpers } from "~/utils/helpers.js";
...
export const tempOrderOperations = {
    ...
    async clearTempSession(sessionID, useKeepAlive = false) {
        try {
