...
export default function ItemSearchModal({
  ...
  const [filters, setFilters] = useState({
    ...
    code: "",
    description: "",
    brand_id: "", // Estos IDs necesitarán dropdowns o selectores en el futuro
    category_id: "",
    subcategory_id: "",
    supplier_id: "",
    oem: "",
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      setResults([]);
      // setFilters({ item_id: "", code: "", description: "", brand_id: "", category_id: "", subcategory_id: "", supplier_id: "", oem: "" });
    }
  }, [isOpen]);
