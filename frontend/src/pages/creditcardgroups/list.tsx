...
import { useGetAllCreditCardGroupsQuery, type CreditCardGroupsInDb } from "~/graphql/_generated/graphql";
import { creditCardGroupOperations } from "~/services/credit-card.service";

type DataInDB = CreditCardGroupsInDb;
...
export default function CreditCardGroups() {
  ...
  useEffect(() => {
    const handler = (e: MessageEvent) => {
      if (e.data === "reload-creditcardgroups") {
        refetch();
      }
    };
  ...
  return (
    <section className="section">
      <AdminTopBar title="Grupos de Tarjetas" quickAccessHidden>
