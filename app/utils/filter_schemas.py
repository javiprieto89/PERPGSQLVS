...
FILTER_SCHEMAS = {
    "clients": [
        ...
        {"field": "DocTypeID", "label": "Tipo de documento",
            "type": "select", "relationModel": "DocType"},
        {"field": "DocNumber", "label": "Número de documento", "type": "text"},
        {"field": "CompanyID", "label": "Compañía",
            "type": "select", "relationModel": "Company"},
        {"field": "BranchID", "label": "Sucursal", "type": "select",
            "relationModel": "Branch", "dependsOn": "CompanyID"},
        ...
        {"field": "CountryID", "label": "País",
            "type": "select", "relationModel": "Country"},
        {"field": "ProvinceID", "label": "Provincia", "type": "select",
            "relationModel": "Province", "dependsOn": "CountryID"},
        {"field": "PriceListID", "label": "Lista de precios",
            "type": "select", "relationModel": "PriceList"},
        {"field": "VendorID", "label": "Vendedor",
            "type": "select", "relationModel": "Vendor"},
    ],
    "suppliers": [
    ...
    "items": [
        ...
        {"field": "BrandID", "label": "Marca",
            "type": "select", "relationModel": "Brand"},
        {"field": "BrandName", "label": "Marca (nombre)", "type": "text"},
        {"field": "ItemCategoryID", "label": "Categoría",
            "type": "select", "relationModel": "ItemCategory"},
        {"field": "CategoryName",
            "label": "Categoría (nombre)", "type": "text"},
        {"field": "ItemSubcategoryID", "label": "Subcategoría", "type": "select",
            "relationModel": "ItemSubcategory", "dependsOn": "ItemCategoryID"},
        {"field": "SubcategoryName",
            "label": "Subcategoría (nombre)", "type": "text"},
        {"field": "SupplierID", "label": "Proveedor",
            "type": "select", "relationModel": "Supplier"},
        {"field": "SupplierName",
            "label": "Proveedor (nombre)", "type": "text"},
        {"field": "ControlStock", "label": "Control de stock", "type": "boolean"},
        {"field": "ReplenishmentStock",
            "label": "Stock de reposición", "type": "number"},
        {"field": "IsActive", "label": "Activo", "type": "boolean"},
        {"field": "IsOffer", "label": "Es oferta", "type": "boolean"},
        {"field": "OEM", "label": "OEM", "type": "text"},
        {"field": "WarehouseID", "label": "Depósito",
            "type": "select", "relationModel": "Warehouse"},
        {"field": "WarehouseName",
            "label": "Depósito (nombre)", "type": "text"},
    ...
    "carmodels": [
        ...
        {"field": "CarBrandID", "label": "Marca",
            "type": "select", "relationModel": "CarBrand"},
    ...
    "cars": [
        ...
        {"field": "CompanyID", "label": "Compañía",
            "type": "select", "relationModel": "Company"},
        {"field": "CarModelID", "label": "Modelo",
            "type": "select", "relationModel": "CarModel"},
        {"field": "CarModelName", "label": "Modelo (nombre)", "type": "text"},
        {"field": "CarBrandID", "label": "Marca",
            "type": "select", "relationModel": "CarBrand"},
        {"field": "CarBrandName", "label": "Marca (nombre)", "type": "text"},
        {"field": "ClientID", "label": "Cliente",
            "type": "select", "relationModel": "Client"},
        ...
        {"field": "LastServiceMileage",
            "label": "Km último servicio", "type": "number"},
        {"field": "IsDebtor", "label": "Es deudor", "type": "boolean"},
        {"field": "DiscountID", "label": "Descuento",
            "type": "select", "relationModel": "Discount"},
        {"field": "DiscountName",
            "label": "Descuento (nombre)", "type": "text"}
    ],
    "itemcategories": [
    ...
    "creditcards": [
        ...
        {"field": "CreditCardGroupID", "label": "Grupo",
            "type": "select", "relationModel": "CreditCardGroup"},
    ...
    "saleconditions": [
        ...
        {"field": "CreditCardID", "label": "Tarjeta",
            "type": "select", "relationModel": "CreditCard"},
    ...
    "orders": [
        ...
        {"field": "BranchID", "label": "Sucursal", "type": "select",
            "relationModel": "Branch", "dependsOn": "CompanyID"},
        {"field": "BranchName", "label": "Sucursal (nombre)", "type": "text"},
        {"field": "OrderDate", "label": "Fecha", "type": "text"},
        {"field": "ClientID", "label": "Cliente",
            "type": "select", "relationModel": "Client"},
        {"field": "ClientName", "label": "Cliente (nombre)", "type": "text"},
        {"field": "CarID", "label": "Auto",
            "type": "select", "relationModel": "Car"},
        {"field": "CarLicensePlate", "label": "Patente", "type": "text"},
        {"field": "IsService", "label": "Es servicio", "type": "boolean"},
        {"field": "ServiceTypeID", "label": "Tipo de servicio",
            "type": "select", "relationModel": "ServiceType"},
        {"field": "Mileage", "label": "Kilometraje", "type": "number"},
        {"field": "NextServiceMileage",
            "label": "Próximo servicio km", "type": "number"},
        {"field": "Notes", "label": "Notas", "type": "text"},
        {"field": "SaleConditionID", "label": "Condición de venta",
            "type": "select", "relationModel": "SaleCondition"},
        {"field": "DiscountID", "label": "Descuento",
            "type": "select", "relationModel": "Discount"},
        {"field": "Subtotal", "label": "Subtotal", "type": "number"},
        {"field": "DiscountAmount", "label": "Descuento aplicado", "type": "number"},
        {"field": "TotalTaxAmount", "label": "Impuestos", "type": "number"},
        {"field": "Total", "label": "Total", "type": "number"},
        {"field": "UserID", "label": "Usuario",
            "type": "select", "relationModel": "User"},
        {"field": "UserName", "label": "Usuario (nombre)", "type": "text"},
        {"field": "OrderStatusID", "label": "Estado",
            "type": "select", "relationModel": "Sysorderstatus"},
        {"field": "OrderStatusName", "label": "Estado (nombre)", "type": "text"},
        {"field": "PriceListID", "label": "Lista de precios",
            "type": "select", "relationModel": "PriceList"},
        {"field": "WarehouseID", "label": "Depósito",
            "type": "select", "relationModel": "Warehouse"},
    ...
    "orderdetails": [
        ...
        {"field": "OrderID", "label": "Orden",
            "type": "select", "relationModel": "Order"},
        {"field": "ItemID", "label": "Ítem",
            "type": "select", "relationModel": "Item"},
    ...
    "documents": [
        ...
        {"field": "DocumentTypeID", "label": "Tipo de documento",
            "type": "select", "relationModel": "SysDocumentType"},
        {"field": "Description", "label": "Descripción", "type": "text"},
