...
class AccountBalances(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['ClientID'], ['Clients.ClientID'],
                             name='FK__AccountBa__Clien__3F115E1A'),
        ForeignKeyConstraint(['SupplierID'], [
                             'Suppliers.SupplierID'], name='FK__AccountBa__Suppl__3E1D39E1'),
        PrimaryKeyConstraint(
            'AccountID', name='PK__AccountB__349DA5866875C1B5')
    )

    AccountID = Column(Integer, Identity(
