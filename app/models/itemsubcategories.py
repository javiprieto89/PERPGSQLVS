...
class ItemSubcategories(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['ItemCategoryID'], [
                             'ItemCategories.ItemCategoryID'], name='FK_ItemSubcategories_ItemCategories'),
        PrimaryKeyConstraint('ItemSubcategoryID',
                             name='PK_ItemSubcategories_1'),
        Index('ix_Subcategories_SubcategoryID', 'ItemSubcategoryID')
    )

    ItemSubcategoryID = Column(Integer, Identity(
    ...
    itemCategories_: Mapped['ItemCategories'] = relationship(
        'ItemCategories', back_populates='itemSubcategories_')
    items_: Mapped[List['Items']] = relationship(
        'Items', back_populates='itemSubcategories_')
