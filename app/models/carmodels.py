...
class CarModels(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['CarBrandID'], [
                             'CarBrands.CarBrandID'], name='FK__CarModels__CarBr__5441852A'),
        PrimaryKeyConstraint(
            'CarModelID', name='PK__CarModel__C585C36F707AD8EA')
    )

    CarModelID = Column(Integer, Identity(
